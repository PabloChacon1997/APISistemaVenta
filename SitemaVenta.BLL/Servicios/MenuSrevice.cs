...
{
    public class MenuSrevice: IMenuService
    {
        ...
        public MenuSrevice(IGenericRepository<Usuario> usuarioRepositorio, IGenericRepository<Menurol> menuRolRepositorio, IGenericRepository<Menu> menuRepositorio, IMapper mapper)
        {
